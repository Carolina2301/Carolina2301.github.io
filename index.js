document.addEventListener("DOMContentLoaded", function() {
  ...
  novoJogoLink.addEventListener("click", function(event) {
    ...
    Swal.fire({
      ...
      showDenyButton: true,
      confirmButtonText: '<div><img src="https://carolina2301.github.io/images/emocao.svg" alt="Imagem"></div><div>Emoções</div>',
      denyButtonText: '<div><img src="https://carolina2301.github.io/images/comida.svg" alt="Imagem"></div><div>Comidas</div>',
