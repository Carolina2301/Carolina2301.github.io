...
document.addEventListener("DOMContentLoaded", function() {
  ...
  novoJogoLink.addEventListener("click", function(event) {
    ...
    Swal.fire({
      ...
      confirmButtonText: '<div><img src="images/emocao.svg" alt="Imagem" class="button-image"></div><div>Emoções</div>',
      ...
      denyButtonText: '<div><img src="images/comida.svg" alt="Imagem" class="button-image"></div><div>Comidas</div>',
